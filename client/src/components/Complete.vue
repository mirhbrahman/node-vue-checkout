<template>
    <div class='container content'>
        ...
        <p>Congratulations! Your order for Sticks will be shipped out within 1-2 business days. We sent you a confirmation email for your records. Thanks so much!</p>
